...
var logger = require('winston'),
    ...
    contextManipulatorService = require('./context.manipulator.service'),
    _ = require('lodash');
    ...
    memory.get(doc.id, function(err, oldObject){
        ...
        var _callback = function(result, operation){
            ...
            if (result) {
                ...
                logger.info('got basic details - Trying to acquire userId');
                if (typeof doc.getContext == 'function') {
                    ...
                    if (data) {
                        ...
                        logger.info('Audit operation for userId [' + data.userId +']');
                    }
                }
